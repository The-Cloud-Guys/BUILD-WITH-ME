...
// @desc    Get all projects with filters (FIXED: excludes sensitive fields)
...
const updateProject = async (req, res) => {
  try {
    ...
    const { title, description, requiredSkills, techStack, stage, roles, status } = req.body;
...
const applyToProject = async (req, res) => {
  try {
    ...
    // No role validation – creator can accept any role
...
// @desc    Get project applications (owner only) - FIXED: full details
